...
const Header: React.FC<HeaderProps> = ({ conversation }) => {
  ...
  const statusText = useMemo(() => {
    if (conversation.isGroup) {
      return `${conversation.users.length} Members`; //群聊
    }
  ...
  return (
    <>
      ...
      <div className="bg-white w-full flex border-b-[1px] sm:px-4 lg:px-6 py-3 px-4 justify-between items-center shadow-sm">
